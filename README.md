...
<i> Note for mac users, you may experience some permission issues when utilising the pem file. If you do, try to run this command: <b>chmod 400 {pem_file_directory}</b> in your terminal.</i>
</p>
